...
class GetTripModel extends BaseResponseModel2<List<TripModel>> {
  const GetTripModel({
  ...
  factory GetTripModel.fromJson(Map<String, dynamic> json) {
    return GetTripModel(
      ...
      body: List<TripModel>.from(json['data'].map((e) => TripModel.fromJson(e)))
          .toList(),
    );
  }
}
